 ...
 <div class="row">
      <div class="col-md-4 alert-success"><br>
        <div class="card" style="width: 15rem;">
                        ...
                        <a href="{{route('form_acProd', $pro->referencia)}}" class="btn btn-secondary">Actualizar</a>
                        <a href="{{route('eliminar_prod', $pro->referencia)}}" class="btn btn-warning">Eliminar</a>
        </div>
        </div>
        <br>
        </div>
